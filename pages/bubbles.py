...
if not rows:
    st.markdown('<div class="ps-panel"><div class="ps-empty"><div class="e">No journal data yet</div>'
                ...
                '15‑minute reviews accumulate — every taken setup and every stand‑aside becomes a row '
...
with tab_ov:
    try:
        ...
        with g2:
            ...
            if months_present:
                seq = _month_seq(tuple(map(int, months_present[0].split("-"))),
