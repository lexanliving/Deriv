...
left, right = st.columns([1, 0], gap="small")  # placeholder to keep grid via raw html below
# We render the two-column body with raw CSS grid by placing chart+ledger and
# rail into a single markdown-free column pair instead, to stay robust:
