...
independent lenses: 30m + 1h agreement (ADX + DI), a closed 15m trigger,
entry-candle ADX / MACD / RSI-zone / structure / pattern checks, a
divergence guard, and adaptive ATR-normalised gates. Signals fire only when
a new 15m candle closes (no repainting).
"""
import time
...
class StrategyEngine:
    """Multi-factor confluence strategy (see module docstring)."""
