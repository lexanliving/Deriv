...
class StateManager:
    ...
    def __init__(self):
        ...
        self._mtf_agreement: int = 0            # 0-3, how many timeframes agree
        self._take_profit_active: bool = False
    ...
    def get_strategy_state(self) -> Dict[str, Any]:
        with self._lock:
            return {
                ...
                "take_profit_active": self._take_profit_active,
            }
    ...
    def reset_for_new_session(self, initial_stake: float):
        ...
        with self._lock:
            ...
            self._take_profit_active = False
            self._current_martingale_step = 0
