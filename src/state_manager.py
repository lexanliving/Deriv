...
- Capped trade history (deque) with an O(1) id index.
- A settled trade can never be updated twice (no double-counted P&L).
- Expectancy math: avg win, avg loss, expectancy per trade.
"""
