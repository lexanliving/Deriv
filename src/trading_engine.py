...
No barriers. Every terminal trade state — WON / LOST / CANCELLED / SKIPPED /
UNKNOWN — is written to the journal with a `note` explaining why, so the log is
a complete decision + execution record.
"""
import asyncio
import time
import uuid
