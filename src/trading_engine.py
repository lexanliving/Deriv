...
Symbol validation is opportunistic (catalogue is a hint, never a gate); the
tick subscription and proposal are the source of truth. No barriers.
Writes every signal evaluation and trade outcome to the decision journal.
"""
import asyncio
import time
import uuid
        ...
        try:
            ...
            if outcome == "UNKNOWN":
                ...
                self._journal.record_outcome(
                    ...
                    self.execution_mode, martingale_step)
            else:
