"""
src/logger.py
Non-blocking centralized logging via QueueHandler + a background listener.
Hot-path log calls only enqueue a record; a single background thread owns the
real file/console handlers, so disk I/O never blocks the trading loop.
"""
