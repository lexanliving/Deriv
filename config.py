...
STRICT_CONTINUATION_TICKS = 3    # Required continuation ticks before signal
MIN_MOMENTUM_TICKS = 7           # Minimum momentum ticks before ARMED transition (was 5)
...
MOMENTUM_CONFIRM_TICKS = STRICT_CONTINUATION_TICKS  # Aliased to STRICT for v4 consistency
