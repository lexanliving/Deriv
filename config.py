...
Trades UP/DOWN as CALL/PUT on a selectable market (Gold by default). No barriers.
...
DERIV_WS_URL = ""  # compatibility only; OTP WebSocket URL is fetched at runtime


# --- Markets (frx* = forex/commodities, 1HZ* = synthetic 1s indices) ---
AVAILABLE_MARKETS = {
