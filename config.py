"""
config.py
Central configuration — MomentumMaster TF (multi-market candle-trend).
"""
...
DERIV_WS_URL = ""  # compatibility only; OTP URL is obtained at runtime
...
BARRIER_BUY = ""   # not used for CALL/PUT
BARRIER_SELL = ""
CURRENCY = "USD"
