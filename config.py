...
# --- Confluence engine (RSI / MACD / ADX / structure / patterns) ----------
# These extend the original candle-trigger engine with a full multi-factor
# confluence stack so a setup has to prove itself across several independent
# lenses (trend strength, momentum, oscillator zone, price action, market
# structure) instead of just "EMA order + one candle break".
RSI_PERIOD = 14
MACD_FAST = 12
MACD_SLOW = 26
MACD_SIGNAL = 9
ADX_PERIOD = 14
ADX_MIN_TREND = 15          # below this, a timeframe is treated as chop (FLAT)
DIVERGENCE_LOOKBACK = 5     # candles back used for the RSI/price divergence check
